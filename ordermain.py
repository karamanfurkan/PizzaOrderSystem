...
sauces = {11: "Zeytin", 12: "Mantar", 13: "Ekstra Kaşar Peyniri", 14: "Et", 15: "Soğan", 16: "Mısır"}
...
with open("Orders_Database.csv", "a") as file:
    file.write(f"{name},{menu[pizza_choice]},{sauces[sauce_choice]},{total_price} TL ,{credit_card}\n")
